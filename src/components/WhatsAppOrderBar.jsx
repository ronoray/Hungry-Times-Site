...
// Persistent bar pinned below navbar — cross-promotes WhatsApp ordering
...
export default function WhatsAppOrderBar() {
  ...
  const handleDismiss = () => {
    setDismissed(true);
    sessionStorage.setItem('wa_order_bar_dismissed', '1');
  };

  return (
    <div className="fixed top-16 left-0 right-0 z-40 bg-[#25D366] text-white px-4 py-2">
      <div className="max-w-7xl mx-auto flex items-center justify-center gap-2 text-sm">
        ...
        <span>
          You can also order on WhatsApp:{' '}
          <a
